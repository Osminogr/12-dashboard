...
const Profile = () => {
  ...
  const u: me_data_info = useAppSelector(state => state.auth.user_data);
  console.log(u)
        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <p className="font-medium">{u.fio}</p>
              <div className="mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-1 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F] text-justify-center">
                {u.role}
              </div>
